jQuery(document).ready(function ($) {
    ...
    var timer;
    var now = new Date();
    var eventStart = new Date(Date.UTC(2016, 1, 13, 3, 0, 0)); // 4:30 + 5:30 = 10:00 AM 
    var eventFinish = new Date(Date.UTC(2016, 1, 14, 3, 0, 0)); // 4:30 + 5:30 = 10:00 AM 
    /*var eventStart  = new Date(2016,1,12,17,4,0);
    var eventFinish = new Date(2016,1,12,17,5,0);*/
